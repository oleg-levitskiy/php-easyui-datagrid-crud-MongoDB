...
<body>
	<table id="dg" title="ItemsTable" class="easyui-datagrid" style="width:100%;height:300"
		...
		<thead>
			...
			<th field="ck" checkbox="true"></th>
				...
				<th field="PARENT_ID" width="50">PARENT_ID</th>
				<th field="NAME" width="50">NAME</th>
				<th field="DATE" width="50">DATE</th>
				<th field="AUTHOR" width="50">AUTHOR</th>
				<th field="FIELD1" width="50">FIELD1</th>
				<th field="FIELD2" width="50">FIELD2</th>
				<th field="FIELD3" width="50">FIELD3</th>
			</tr>
		</thead>
	</table>
	<div id="toolbar">
	...
	<div id="dlg" class="easyui-dialog" style="width:400px;height:280px;padding:10px 20px"
		...
		<form id="fm" method="post" novalidate>
			<div class="fItem">
				<label>id:</label> <input name="id" class="easyui-textbox"  readonly="true">
			</div>
			<div class="fItem">
				<label>PARENT_ID:</label><input name="PARENT_ID" class="easyui-textbox" >
				<label>NAME:</label><input name="NAME" class="easyui-textbox" >
				<label>DATE:</label><input name="DATE" class="easyui-textbox" >
				<label>AUTHOR:</label><input name="AUTHOR" class="easyui-textbox" >
				<label>FIELD1:</label><input name="FIELD1" class="easyui-textbox">
				<label>FIELD2:</label><input name="FIELD2" class="easyui-textbox">
				<label>FIELD3:</label><input name="FIELD3" class="easyui-textbox">
			</div>
		</form>
	</div>
	<div id="dlg-buttons">
